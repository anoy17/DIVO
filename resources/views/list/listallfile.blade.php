                ...
                <div class="nk-block nk-block-lg">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">All Files <a href="addfile" class="btn btn-primary btn-sm"><em class="ti-plus"></em>ADD NEW</button></a></h4>
...
<div id="modal_aside_left" id="modal_aside_left" class="modal fixed-left fade" tabindex="-1" role="dialog">
    ...
    $('.btn-detail').click(function() {
        ...
        success:function(data) {
            ...
            $('#filenumber').html(data.filenumber);
