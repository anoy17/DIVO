                        ...
                        <div class="nk-header-wrap">
                            <div class="nk-header-brand">
                                <a href="dashboard" class="logo-link">
                                    <img class="logo-img" src="../images/fmlogo.png" srcset="../images/fmlogo.png" alt="logo">
                            ...
                            <div class="nk-header-menu">
                                ...
                                <input type="search" class="mx-auto nk-main form-control form-control-sm" style="width: 800px"  placeholder="Search in Warehouses" aria-controls="nk-main">
                                </li>
                                    ...
                                    <li class="dropdown user-dropdown">
                                        <a href="#" class="dropdown-toggle me-lg-n1" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <img class="logo-img" src="../images/avatar/a-sm.jpg"  alt="logo">
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    <div class="user-avatar">
                                                        <span> <img class="logo-img" src="../images/avatar/a-sm.jpg"  alt="logo"></span>
                                                    </div>
                                                    <div class="user-info">
